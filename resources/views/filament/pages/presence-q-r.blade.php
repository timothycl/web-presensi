                ...
                @forelse($companies as $company)
                    <style>
                        @media (max-width: 640px) {
                            .qr-header { flex-direction: column !important; align-items: center !important; text-align: center; gap: 1.5rem; }
                            .qr-header-actions { width: 100%; justify-content: center; }
                            .qr-card { padding: 1.5rem !important; }
                        }
                    </style>
                    <div class="fi-card" style="background: rgba(15, 23, 42, 0.7); backdrop-filter: blur(24px) saturate(180%); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 2.5rem; padding: 3rem; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5); overflow: hidden; font-family: 'Outfit', sans-serif;">
                        <div class="qr-header" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 3rem;">
                            <div>
                            ...
                            <div class="qr-header-actions" style="display: flex; gap: 1rem;">
                        ...
                        <div style="display: flex; justify-content: center;">
                            {{-- QR Card --}}
                            <div id="check-in-card-{{ $company->id }}" class="group/card qr-card" style="width: 100%; max-width: 400px; background: rgba(15, 23, 42, 0.95); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 3rem; padding: 3rem; display: flex; flex-direction: column; align-items: center; gap: 2rem; position: relative; transition: all 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275);">
